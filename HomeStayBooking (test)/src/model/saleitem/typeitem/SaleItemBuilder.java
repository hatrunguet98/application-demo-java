...
//        return this;
//    }
//    public SelectSaleItem build() {
//        return new SelectSaleItem(this.id,this.length,this.width,this.unitPrice,this.rateType,this.dateAudit,this.address,this.numberOfPerson,this.listRoom,this.describe,this.idHost);
//    }
//}
//
//
