...
public class SaleItem implements Serializable {
    ...
    public SaleItem(String id, String type, double unitPrice, boolean booking, double rateType, double acreage, Date updateAudit, Date createdAudit, Date issueAudit, String address, int numberOfPerson, String describe, String hostId) {
        this.id = id;
        this.type = type;
